...
const startLogoutTimer = function () {
  const tick = function () {
    ...
    // When 0 sec, stop timeer and log out user
    if (time === 0) {
      clearInterval(timer);
...
console.log(478798798798789798987970000n);
console.log(BigInt(8908908908));

// Operations
console.log(10000n + 10000n);

const huge = 2028989809809809833432n;
const num = 23;
...
console.log(new Date(2037, 10, 29, 15, 11, 9));
...
/*
// Worjing with dates
const future = new Date(2024, 9, 15, 15, 11, 9);
console.log(future);
console.log(future.getFullYear());
console.log(future.getMonth());
console.log(future.getDate());
console.log(future.getDay()); // Tuesday
console.log(future.getHours());
console.log(future.toISOString());

console.log(future.getTime());
console.log(new Date(1729019469000));
